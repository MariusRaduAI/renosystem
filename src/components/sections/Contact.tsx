...
import { contact, business } from "@/content/de";
...
export default function Contact() {
  ...
  return (
    <section id="kontakt" className="bg-concrete-950 py-24 sm:py-32 noise-texture">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-5 max-w-md text-lg leading-relaxed text-concrete-300">{contact.intro}</p>
            ...
            <p className="mt-8 text-sm text-concrete-300">{contact.regionNote}</p>
          </div>

          <div className="blueprint-corners rounded-sm bg-concrete-100 p-6 sm:p-8">
            {state.status === "success" ? (
              <div className="flex min-h-[320px] flex-col items-center justify-center text-center">
                <span className="text-3xl text-wood-600" aria-hidden="true">
                  ✓
                </span>
                <h3 className="mt-4 font-display text-xl font-bold text-concrete-950">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-concrete-950">
                  {contact.step1.question}
                </h3>
              ...
              <form action={formAction}>
                ...
                <div className="mt-5 space-y-4">
                  ...
                  {state.status === "error" && (
                    <p className="rounded-sm bg-safety/10 px-4 py-3 text-sm text-safety">
